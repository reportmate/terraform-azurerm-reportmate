...
- ✅ **OAuth Configuration**: Redirect URIs configured for reportmate.example.edu
...
### **Important URLs**
- **Homepage**: https://reportmate.example.edu
- **Sign-in**: https://reportmate.example.edu/auth/signin
- **OAuth Callback**: https://reportmate.example.edu/api/auth/callback/azure-ad
...
curl https://reportmate.example.edu/api/auth/providers
curl https://reportmate.example.edu/auth/signin
```
