...
Test-JsonEndpoint "FastAPI Individual Device" "$FastAPIUrl/api/device/TESTSERIAL0001"
...
Test-Endpoint "Frontend Device Detail" "$FrontendUrl/device/TESTSERIAL0001"
...
Test-JsonEndpoint "Frontend API Individual Device" "$FrontendUrl/api/device/TESTSERIAL0001"
...
try {
    $FastAPIDevice = Invoke-RestMethod -Uri "$FastAPIUrl/api/device/TESTSERIAL0001" -TimeoutSec 10
    $FrontendDevice = Invoke-RestMethod -Uri "$FrontendUrl/api/device/TESTSERIAL0001" -TimeoutSec 10
    ...
    if ($FastAPISerial -eq $FrontendSerial -and $FastAPISerial -eq "TESTSERIAL0001") {
