...
try {
    $deviceResponse = Invoke-RestMethod -Uri "https://reportmate-api.azurewebsites.net/api/device/TESTSERIAL0001" -TimeoutSec 30
    if ($deviceResponse) {
...
Write-Host "   Device: https://reportmate-api.azurewebsites.net/api/device/TESTSERIAL0001" -ForegroundColor White  
